...
public final class JSONTag {
    ...
    public final class Alojamiento {
        ...
        public static final String TAG_AUTOCARAVANA = "AUTOCARAVANA";
        public static final String TAG_TIENDA = "TIENDA";
        public static final String TAG_CAPACIDAD = "CAPACIDAD";
        public static final String TAG_GASTRONOMICO = "GASTRONOMICO";
    ...
    public final class Relacion{
        public static final String TAG_RELACION = "RELACION_CP_MUNICIPIOS_PROVINCIAS";
    ...
    public final class Provincia{
        public static final String TAG_PROVINCIA = "PROVINCIAS";
    ...
    public final class Tipo_Euskera{
        public static final String TAG_TIPO_EUSKERA = "TIPOS_EUSKERA";
    ...
    public final class Codigo_Postal{
        public static final String TAG_POST_CODE = "CODIGOS_POSTALES";

        public static final String TAG_CODIGO_POSTAL = "CODIGO_POSTAL";
    }

    public final class Categoria{
        public static final String TAG_CATEGORIA = "CATEGORIAS";
    ...
    public final class Tipo {
        public static final String TAG_TIPO = "TIPOS";
